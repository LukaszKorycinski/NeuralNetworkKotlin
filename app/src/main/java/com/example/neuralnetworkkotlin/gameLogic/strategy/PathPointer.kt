...
private const val PATH_SIZE = .7f
...
class PathPointer() {
    ...
    fun draw(mvpMatrix: FloatArray, textureHandle: Int, shader: Int, textures: TexturesLoader) {
        if (initialized) {
            ...
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textures.textureHandle[textureHandle])
