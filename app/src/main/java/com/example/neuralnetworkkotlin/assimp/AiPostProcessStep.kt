...
enum class AiPostProcessStep(@JvmField val i: Int) {
     ...
     */
    TargetRealtime_Fast(
        CalcTangentSpace.i or GenNormals.i or JoinIdenticalVertices.i or Triangulate.i or GenUVCoords.i
            or SortByPType.i),
    ...
    TargetRealtime_Quality(
        CalcTangentSpace.i or GenSmoothNormals.i or JoinIdenticalVertices.i or ImproveCacheLocality.i
